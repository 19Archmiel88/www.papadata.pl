  ...
  en: {
    ...
    features: {
      ...
      ai_assistant: {
        ...
        details: ['Anomaly detection + root cause', 'Fast actionable insights'],
        commonUses: [
      ...
      discounts: {
        ...
        details: ['Promo efficiency (Incrementality vs. Organic Sales)', 'Net profit impact'],
        commonUses: [
      ...
      reports: {
        ...
        details: ['PDF reports + KPI summaries', 'Automated scheduling and delivery'],
        commonUses: ['Single source of truth for team and agency', 'Quick period comparisons'],
      ...
      funnel: {
        ...
        details: ['Payment process optimization', 'Page conversion'],
        commonUses: [
      ...
      customers: {
        ...
        details: ['Cohort retention', 'LTV and CAC tracking', 'VIP identification'],
        commonUses: [
    ...
    etl: {
      ...
      step2_desc:
        'Cleans, normalizes, and enriches data: SKUs, currencies, timezones, and campaign naming.',
      step3_title: 'INDEXING',
      step3_desc:
        'Builds a contextual index for the AI Assistant to find answers and root causes faster.',
      step4_title: 'OUTPUT TO BIGQUERY',
      step4_desc:
        'Saves ready tables in BigQuery — instantly available for KPIs, dashboards, and alerts.',
      meta_step_router: '',
      meta_active_label: '',
      meta_footer: '',
    },
    integrations: {
      ...
      modal_desc:
        'Choose data sources — PapaData will combine them into one model in BigQuery and ensure consistency (currencies, time zones, campaigns, SKUs).',
    ...
    roi: {
      ...
      rate_ent: 85,
      efficiency_note:
        'Right decisions based on your business data and PapaData recommendations, showcasing trends and market insights, will increase your business efficiency by much more than what you can save with us just by saving time from the start.',
    },
    security: {
      pill: 'SECURITY',
      ...
      card1_desc:
        'Access control ensures only authorized personnel can see specific data and reports.',
      card2_tag: 'ISOLATION',
      ...
      card4_desc:
        'External connections are encrypted, and data is protected in transit and at rest.',
    ...
    pricing: {
      ...
      starter: {
        ...
        price: '199',
        features: ['Up to 3 data sources', 'Weekly reports', 'Email support', 'Basic AI insights'],
      ...
      professional: {
        ...
        price: '499',
        features: ['Up to 15 data sources', 'Daily reports', 'Priority support', 'Priority AI'],
        cta: 'ROZPOCZNIJ TRIAL',
      },
      enterprise: {
        name: 'Enterprise',
    ...
    socialProof: {
      ...
      reviews: [
        {
          quote: 'PapaData transformed our reporting workflow.',
          author: 'John Doe',
          role: 'CEO at FashionBrand',
        },
      ],
    },
    vertexPlayer: {
      ...
      content: {
        ai: {
          ...
          desc: 'Ask anything about your data in natural language.',
        },
        pipeline: {
          title: 'Anomaly Detection',
          desc: 'Real-time monitoring of performance drops.',
        },
    ...
    dashboard: {
      ...
      trial_expired_desc:
        'Production features are paused until subscription is activated. Your data and settings stay intact.',
      ...
      billing: {
        ...
        trial_modal_desc_7:
          'Trial ends in {days} days. Add a payment method to keep continuous access.',
      ...
      overview_v2: {
        ...
        insights: {
          items: [
            {
              id: 'ins-1',
              title: 'Largest ROAS drop in Campaign X',
              impact: '-18% vs week',
              context: 'Campaign X',
            },
            {
              id: 'ins-2',
              title: 'Returns rising for SKU Y',
              impact: '+6% in 7d',
              context: 'SKU Y',
            },
            {
              id: 'ins-3',
              title: 'New VIP segment increases LTV',
              impact: '+12% in 30d',
              context: 'VIP Segment',
            },
          ],
      ...
      growth: {
        title: 'GROWTH ENGINE',
        desc: 'Scale your sales',
        cards: {
          title: 'Recommendation Cards',
          desc: 'Suggested business actions',
          labels: {
            impact: 'IMP',
            confidence: 'CONF',
            effort: 'EFF',
        ...
        budget: {
          title: 'Budget',
          desc: 'Allocation optimization',
          toggle_channels: 'Channels',
          toggle_campaigns: 'Campaigns',
          current_label: 'Current',
          suggested_label: 'Suggested',
          aggressiveness_label: 'Strategy',
          ...
          assumptions_text: 'Based on historical trends and AI.',
          channels: [],
          campaigns: [],
        },
      },
      ads_v2: {
        ...
        media_mix: {
          ...
          badge_freshness: '',
          badge_quality: '',
          action_breakdown: 'View',
          action_explain: 'Analyze',
          tooltip_share: 'Share',
          tooltip_driver: 'Reason',
        },
        efficiency: {
          title: 'Efficiency',
          desc: 'ROAS/CPA',
          metric_roas: 'ROAS',
          metric_cpa: 'CPA',
          action_show_campaigns: 'View',
          action_explain: 'Explain',
        },
        share: {
          title: 'Market share',
          desc: 'Share of Voice',
          spend_label: 'Spend Share',
        ...
        drilldown: {
          ...
          level_adset: 'Ad set',
          level_creative: 'Creative',
        },
        ai_prompt: 'Explain {name}',
      },
      products_v2: {
        title: 'SKU intelligence',
        desc: 'Product and logistics data',
        ai_prompt: 'Analyze {name}',
        items: [
        ...
        scatter: {
          title: 'SKU Matrix',
          desc: 'Margin vs volume analysis',
          context_template: 'Product: {name}',
          size_label: 'Volume',
          x_label: 'Margin %',
          y_label: 'Net profit',
          hint_top_right: 'BESTSELLERY',
          hint_bottom_right: 'CASH COWS',
          hint_top_left: 'POTENTIAL',
          hint_bottom_left: 'OGONY',
          tooltip_profit: 'Profit',
          tooltip_margin: 'Margin',
          tooltip_units: 'Units',
          tooltip_returns: 'Returns',
          tooltip_stock: 'Stock',
          tooltip_trend: 'Trend',
          tooltip_driver: 'Reason',
          tags: { toxic: 'TOKSIC', high_margin: 'HIGH MARGIN', stock_risk: 'STOCK RISK' },
          multi_select_label: 'Selected',
          compare: { cta_ai: 'AI', cta_compare: 'Compare', cta_clear: 'X' },
        },
        details: {
          title: 'SKU Detail',
          empty: 'Select a product from the matrix',
          empty_cta: 'Select first',
        ...
        movers: {
          ...
          desc: 'Top changes',
          rising_label: 'Rising',
          falling_label: 'Falling',
          cta_alert: 'Stock alert',
          cta_ai: 'Explain',
      ...
      customers_v2: {
        ...
        desc: 'Customer retention and LTV',
        ai_prompt: 'Explain {name}',
        summary: { retention_label: 'Avg. Retention', vip_label: 'Active VIPs' },
        cohorts: {
          title: 'Cohort Retention',
          desc: 'Customer return rate',
          mode_month: 'Monthly',
          mode_week: 'Weekly',
          row_label: 'Purchase date',
          row_prefix: 'M',
          col_prefix: 'M',
          small_sample: 'Small sample size',
          context_label: 'Cohort',
          tooltip_retention: 'Retention',
          tooltip_size: 'Size',
      ...
      reports_v2: {
        ...
        list: {
          ...
          items: [],
          actions: { preview: 'View', download: 'Download', open: 'Link' },
        },
        generate: {
          title: 'New Report',
          desc: 'Quick generation',
          cta: 'Run Engine',
          fields: [{ label: 'L', value: 'V' }],
          sections: ['Overview', 'Revenue', 'Profit'],
        },
      ...
      pipeline_v2: {
        title: 'DATA PIPELINE',
        desc: 'ETL and sync status',
        ai_prompt: 'Error analysis {name}',
        ...
        sources: {
          ...
          items: [],
          actions: { test: 'Test', sync: 'Sync', explain: 'Analyze' },
        },
        transforms: {
          title: 'Transformation',
          desc: 'Cleaning and RAG',
          items: [],
          actions: { run: 'Run' },
        },
        rag: {
          ...
          items: [
            {
              ...
              impact: 'Inconsistency in P&L Revenue',
              severity: 'Critical',
            },
            {
              id: 'q2',
              title: 'Ad Spend Mismatch',
              impact: 'Meta Ads vs BigQuery Delta > 5%',
              severity: 'Warning',
            },
            {
              id: 'q3',
              title: 'Missing SKU Metadata',
              impact: 'Empty margin for 12 new items',
              severity: 'Info',
            },
            {
              id: 'q4',
              title: 'ETL Connection Lag',
              impact: 'Latency increased to 450ms',
              severity: 'Warning',
            },
          ],
      ...
      integrations_v2: {
        title: 'INTEGRATIONS',
        desc: 'Connection management',
        header_badge: 'System Hub Active',
        search_placeholder: 'Search connector...',
        filters: {
          all: 'All',
          active: 'Active',
          disabled: 'Disabled',
        ...
        status_attention: 'Issue',
        status_connecting: 'Connecting...',
        status_connected: 'Connected',
        active_connectors_label: 'Active Connectors',
        records_synced_label: 'Records Synced',
        uptime_label: 'Uptime (30d)',
        auth_prefix: 'Auth',
        sync_prefix: 'Sync',
        scope_label: 'Scope',
        scope_default: 'Full access',
        auth_label: 'Auth',
        last_sync_label: 'Sync',
        last_sync_recent: 'Just now',
        last_sync_delay: 'Delay',
        last_sync_disabled: 'Disabled',
        freshness_label: 'SLA',
        freshness_status: '99.9% OK',
        actions: { test: 'Test', details: 'Show', refresh: 'Sync' },
        security_badge_label: 'Encryption Protocol Active',
        security_title: 'Secure Centralization',
        security_desc:
          'All connections are encrypted with AES-256. Your data stays in a dedicated BigQuery environment in the selected EU region.',
        security_cta_keys: 'Manage Keys',
        security_cta_sla: 'Download SLA Report',
      },
      knowledge_v2: {
        title: 'KNOWLEDGE BASE',
        desc: 'Guides and strategies',
        ...
        booking: {
          ...
          guarantee_desc:
            'The session will be billed after confirming the date. Refunds if no actionable recommendations are delivered.',
        ...
        resources: [
          {
            ...
            longContent:
              'Scaling Meta Ads requires moving from ad set-level optimizations to broad targeting and stronger creative. Learn how Advantage+ changes the rules and why BigQuery retention is key for attribution modeling.\n\nKey topics:\n- Account structure 2.0: Less is more\n- Creative testing framework: Find winners\n- Using CAPI to stabilize results.',
          },
          {
            id: 'res-2',
            category: 'DATA',
            ...
            module: 'Pipeline',
            longContent:
              'Understanding your BigQuery schema is step one to advanced LTV models. We compare nested vs flat structures and how partitioning impacts operational costs at scale.',
          },
          {
            id: 'res-3',
            category: 'AI',
            ...
            longContent:
              'Papa AI is more than a chatbot. It is a data warehouse interface. Learn Chain-of-Thought techniques so the assistant explains correlations between ROAS and abandoned carts across customer segments.',
          },
        ],
      },
      settings_workspace_v2: {
        ...
        attribution: {
          ...
          models: [
            {
              id: 'dda',
              label: 'Data-Driven AI',
              desc: 'Uses ML to weigh each touchpoint.',
              default: true,
            },
            {
              id: 'last_click',
              label: 'Last Click Paid',
              desc: '100% of conversions go to the last paid channel.',
              default: false,
            },
            {
              id: 'linear',
              label: 'Linear',
              desc: 'Equal credit across all interactions.',
              default: false,
            },
            {
              id: 'first_click',
              label: 'First Click',
              desc: 'Boosts top-funnel awareness channels.',
              default: false,
            },
          ],
        },
        integrations: {
          ...
          items: [
            ...
            },
            {
              ...
              desc: 'Account: 942-011-222',
              status: 'Active',
            },
            {
              id: 'ga4',
              label: 'Google Analytics 4',
              desc: 'Property: 28419201',
              status: 'Active',
            },
          ],
        },
        ...
        footer_note: 'Save required',
        cta_primary: 'Deploy to production',
        cta_secondary: 'Save changes',
      },
      settings_org_v2: {
        title: 'Organizations',
        desc: 'Account and billing management',
        ...
        privacy: {
          ...
          items: [],
          cta_export: 'Download data',
          cta_delete: 'Delete account',
        },
          ...
          billing_plans: [
            {
              id: 'starter',
              name: 'Starter',
              price: '159 PLN/mo (annual) / 199 PLN/mo',
              note: 'Up to 3 sources, weekly report',
            },
            {
              id: 'pro',
              name: 'Professional',
              price: '399 PLN/mo (annual) / 499 PLN/mo',
              note: 'Up to 15 sources, daily report',
            },
            {
              id: 'enterprise',
              name: 'Enterprise',
              price: 'Custom pricing',
              note: 'Unlimited sources, real-time reports',
            },
          ],
          invoices: [
      ...
      alerts_v2: {
        ...
        prompt_template:
          'Explain the alert "{title}" in the context of {context}. What remediation steps do you recommend?',
        empty_state: 'No active alerts for selected filters',
        impact_template: 'Impact: {value} vs average',
        mock_alerts: [
          {
            title: 'ROAS anomaly: Meta Ads',
            context: 'Meta Ads Performance',
            target: 'ads',
            severity: 'critical',
            baseProb: 0.9,
          },
          {
            title: 'Projected stock-out SKU-42',
            context: 'Inventory Logistics',
            target: 'products',
            severity: 'warning',
            baseProb: 0.7,
          },
          ...
          {
            title: 'ETL delay: Google Analytics',
            context: 'GA4 Pipeline',
            target: 'guardian',
            severity: 'warning',
            baseProb: 0.6,
          },
          {
            title: 'CPA increase: Search Brand',
            context: 'Google Ads Search',
            target: 'ads',
            severity: 'warning',
            baseProb: 0.5,
          },
          {
            title: 'New VIP segment identified',
          ...
          {
            title: 'Shopify API instability',
            context: 'Shopify Connector',
            target: 'integrations',
            severity: 'warning',
            baseProb: 0.3,
          },
          {
            title: 'LTV goal reached: Cohort M2',
            context: 'Cohort Retention',
            target: 'customers',
            severity: 'info',
            baseProb: 0.2,
          },
          {
            title: 'Bot traffic detected (Referral)',
            context: 'Analytics Quality',
            target: 'guardian',
            severity: 'warning',
            baseProb: 0.45,
          },
      ...
      pnl_title: 'P&L',
      pnl_model: 'Model',
      pnl_net_margin_label: 'Net Margin',
      ...
      pnl_after_opex: 'After OpEx',
      pnl_waterfall: 'Waterfall',
      pnl_region_label: 'Region',
      pnl_final_state: 'Final State',
      pnl_cost_breakdown: {
        ad_spend: 'Ad spend',
        cogs: 'COGS',
        fees: 'Fees',
      ...
      pnl_dim_category: 'Category',
      pnl_badge_audited: 'Audited',
      pnl_revenue: 'Revenue',
      pnl_cogs: 'COGS',
      pnl_fees: 'Fees',
      pnl_refunds: 'Refunds',
      pnl_shipping: 'Shipping',
      pnl_ad_spend: 'Ad Spend',
      pnl_payroll: 'Payroll',
      pnl_tools: 'Tools',
      pnl_contribution: 'Contribution',
      pnl_export_live: 'Export',
      pnl_export_audit_pdf: 'Download audit PDF',
      pnl_context_template: 'P&L Line: {label} ({value})',
      pnl_ai_prompt_template:
      ...
      ads_title: 'Ads',
      ads_attribution: 'Attr',
      ads_total_roas: 'ROAS',
      ads_status_optimal: 'Optimal',
      ads_spend_vs_revenue: 'S/R',
      ads_latency: 'Lat',
      ads_label_spend: 'Spend',
      ads_label_revenue: 'Rev',
      ads_automations: 'Auto',
      ads_agent: 'Agent',
      ads_auto_bid: 'Bid',
      ads_anomaly_detect: 'Anomaly',
      ads_fraud_filter: 'Fraud',
      ads_creative_fatigue: 'Fatigue',
      ads_open_live: 'Live',
      ads_channel_matrix: 'Matrix',
      ads_model_refreshed: 'Refreshed',
      ads_col_channel: 'Ch',
      ads_col_spend: 'Spend',
      ads_col_revenue: 'Rev',
      ads_col_roas: 'ROAS',
      ...
      customers_title: 'Cust',
      customers_dim_segment: 'Seg',
      customers_pii_masked: 'Masked',
      customers_segment_new: 'New',
      customers_segment_returning: 'Ret',
      customers_segment_vip: 'VIP',
      customers_aov: 'AOV',
      customers_ltv: 'LTV',
      customers_repeat_rate: 'Rep',
      customers_open_cohorts_live: 'Cohorts',
      customers_cohort_title: 'Title',
      customers_metric_returning: 'Returning',
      customers_cohort_label: 'Cohort',
      customers_month_label: 'Month',
      customers_model_note: 'Note',
      products_title: 'Prod',
      products_dim_sku: 'SKU',
      products_stock_signal: 'Stock',
      products_col_sku: 'SKU',
      products_col_product: 'Product',
      products_col_units: 'Units',
      products_col_revenue: 'Rev',
      products_col_margin: 'Margin',
      products_col_stock: 'Stock',
      products_col_status: 'Status',
      products_status_ok: 'Healthy',
      products_status_low: 'Low',
      products_status_crit: 'Crit',
      products_suggestion: 'Sugg',
      products_restock_prefix: 'Restock ',
      products_restock_suffix: ' units',
      products_open_inventory_live: 'Inv',
      products_price_signal: 'Price',
      products_elasticity_model: 'Elast',
      products_discount_opt: 'Disc',
      products_bundle_opt: 'Bundle',
      products_risk_stockout: 'Risk',
      products_return_risk: 'Ret',
      products_note_best_for: 'Best for',
      products_note_bundle: 'Note',
      products_note_risk_stockout: 'Warning',
      products_note_return_risk: 'Returns',
      products_open_pricing_lab: 'Pricing',
      alerts_title: 'Alerts',
      alerts_stream: 'Stream',
      alerts_ack_required: 'Ack',
      alerts_action_prefix: 'Act: ',
      alerts_ack: 'Ack',
      alerts_acked: 'Acked',
      alerts_open_runbook: 'Runbook',
      alerts_notify_policy: 'Policy',
      alerts_channel_email: 'Email',
      alerts_channel_slack: 'Slack',
      alerts_channel_sms: 'SMS',
      alerts_quiet_hours: 'Quiet',
      alerts_quiet_hours_window: 'Window',
      alerts_connect_live_channels: 'Connect',
      alerts_severity_alert: 'Alert',
      alerts_severity_security: 'Security',
      ...
      settings_days: 'days',
      settings_connector_tokens: 'Tokens',
      settings_scoped_auth: 'Scoped',
      settings_connector_shopify_label: 'Shopify',
      settings_connector_shopify_desc: 'Desc',
      settings_connector_allegro_label: 'Allegro',
      settings_connector_allegro_desc: 'Desc',
      settings_connector_google_ads_label: 'GAds',
      settings_connector_google_ads_desc: 'Desc',
      settings_connector_meta_capi_label: 'Meta',
      settings_connector_meta_capi_desc: 'Desc',
      settings_connector_ga4_label: 'GA4',
      settings_connector_ga4_desc: 'Desc',
      settings_connector_email_label: 'Email',
      settings_connector_email_desc: 'Desc',
      settings_apply_live: 'Apply',
      ...
      status_high: 'High',
      status_low: 'Low',
      tenant_mode_delay: 'Delay',
      tenant_mode_demo: 'Demo',
      tenant_mode_live: 'Live',
      ...
      products_catalog: [],
      cohort_week_prefix: 'W',
      cohort_month_prefix: 'M',
      guardian_logs: [],
      range_1d: '1d',
      range_7d: '7d',
      range_30d: '30d',
      ...
      compare_yoy: 'YoY',
      compare_y: 'Y',
      attribution_last_click: 'Last',
      attribution_data_driven: 'Data',
      attribution_diff_badge: 'Diff',
      attribution_undo: 'Undo',
      ...
      filter_option_meta: 'Meta',
      filter_option_google: 'Google',
      filter_option_tiktok: 'TikTok',
      filter_option_affiliate: 'Aff',
      filter_option_account_a: 'A',
      filter_option_account_b: 'B',
      filter_option_brand: 'Brand',
      filter_option_prospecting: 'Prosp',
      filter_option_retargeting: 'Ret',
      filter_option_pl: 'PL',
      filter_option_de: 'DE',
      filter_option_cz: 'CZ',
      filter_option_uk: 'UK',
      filter_option_mobile: 'Mob',
      filter_option_desktop: 'Desk',
      filter_option_tablet: 'Tab',
      filter_option_new: 'New',
      filter_option_returning: 'Ret',
      filter_option_vip: 'VIP',
      filter_option_top_sellers: 'Top',
      filter_option_low_margin: 'Low',
      filter_option_bundles: 'Bundles',
      filter_option_shopify: 'Shopify',
      filter_option_allegro: 'Allegro',
      filter_option_pos: 'POS',
      sidebar_tagline: 'Tag',
      nav_group_start: 'Start',
      nav_group_ai: 'AI',
      nav_group_performance: 'Perf',
      nav_group_fundamentals: 'Fund',
      nav_group_ops: 'Ops',

      session_processing: 'Proc',
      session_error: 'Err',

      command_empty: 'None',
      command_nav_hint: 'Hint',
      command_action_report: 'Rep',
      command_action_report_desc: 'Desc',
      command_action_alert: 'Alrt',
      command_action_alert_desc: 'Desc',
      command_action_pipeline: 'Pipe',
      command_action_pipeline_desc: 'Desc',
      command_action_integrations: 'Int',
      command_action_integrations_desc: 'Desc',
      command_action_go_live: 'Live',
      command_action_go_live_desc: 'Desc',
      command_action_workspace: 'Work',
      command_action_workspace_desc: 'Desc',
      command_resource_roas: 'ROAS',
      command_resource_roas_desc: 'Desc',
      command_resource_bigquery: 'BQ',
      command_resource_bigquery_desc: 'Desc',
      command_resource_ai: 'AI',
      command_resource_ai_desc: 'Desc',
      notifications_title: 'Notif',
      notification_roas_title: 'ROAS',
      notification_roas_desc: 'Desc',
      notification_roas_time: 'Time',
      notification_delay_title: 'Delay',
      notification_delay_desc: 'Desc',
      notification_delay_time: 'Time',
      notification_action_explain: 'Explain',
      notification_action_open: 'Open',
      notification_action_quality: 'Qual',
      context_meta_roas: 'Meta',
      ...
      account_access: 'ACC',
      account_billing: 'BILL',
      account_logout: 'LOG',
      account_end_session: 'END',
      cta_go_live: 'GO',
      demo_banner_title: 'DEMO',
      demo_banner_desc: 'SYNTH',
      demo_banner_cta_primary: 'LIVE',
      demo_banner_cta_secondary: 'UP',
      demo_banner_cta_tertiary: 'LEARN',
      demo_banner_dismiss: 'X',
    ...
    promo_v2: {
      main: {
        ...
        subhead:
          'Connect sources and see KPIs + alerts on your own data. Most chosen: Professional.',
      ...
      intercept: {
        ...
        subhead:
          'If you plan more than 3 sources or want daily alerts, Professional will save you time from day one.',
        bullets: [
    ...
    cookies: {
      ...
      necessary_desc:
        'Ensure basic site operations, security, and core functions like session maintenance and fraud protection.',
      necessary_tag: 'REQUIRED',
      analytical_label: 'Analytical (GA4)',
      analytical_desc:
        'Help us understand how users interact with the site (e.g., number of visits, traffic sources) to improve products and content.',
      analytical_tag: 'OPTIONAL',
      marketing_label: 'Marketing (Google Ads, Meta)',
      marketing_desc:
        'Used to measure campaign effectiveness and—if you consent—to tailor advertisements (e.g., remarketing).',
      marketing_tag: 'OPTIONAL',
      functional_label: 'Functional / Preferences',
      functional_desc:
        'Remember additional settings like preferences to make your experience smoother.',
      ...
      providers_desc:
        'Below is a list of tools used on our site. Details (storage time, data scope, legal basis) are in our Cookie Policy.',
      provider_ga4:
        'Google Analytics 4 (Google LLC) – measurement of site traffic and behavior (aggregates/stats).',
      provider_ads:
        'Google Ads (Google LLC) – conversion measurement and campaign effectiveness, remarketing (with consent).',
      provider_meta:
        'Meta Pixel (Meta Platforms, Inc.) – conversion measurement and campaign effectiveness, remarketing (with consent).',
      provider_gtm:
        'Google Tag Manager (Google LLC) – tool for firing tags; does not perform profiling on its own.',
      cookie_ids_label: 'Sample cookie identifiers',
      cookie_ids_desc:
        'Cookie names may vary based on provider configuration and updates (e.g., _ga/_gid for GA4, gcl* for Google Ads, _fbp for Meta).',
  ...
  pl: {
    ...
    features: {
      ...
      reports: {
        ...
        details: ['Raporty PDF + podsumowania KPI', 'Automatyczne planowanie i wysyłka'],
        commonUses: [
      ...
      funnel: {
        ...
        details: ['Optymalizacja procesu płatności', 'Konwersja stron'],
        commonUses: [
      ...
      customers: {
        ...
        details: ['Retencja kohortowa', 'Śledzenie LTV i CAC', 'Identyfikacja VIP'],
        commonUses: [
    ...
    etl: {
      ...
      step2_title: 'SMART TRANSFORMATION',
      step2_desc:
        'Czyści, normalizuje i wzbogaca dane: SKU, waluty, strefy czasowe i nazewnictwo kampanii.',
      step3_title: 'INDEKSOWANIE',
      step3_desc:
        'Buduje kontekstowy indeks dla Asystenta AI, aby szybciej znajdował odpowiedzi i przyczyny źródłowe.',
      step4_title: 'WYJŚCIE DO BIGQUERY',
      step4_desc:
        'Zapisuje gotowe tabele w BigQuery — natychmiast dostępne dla KPI, dashboardów i alertów.',
      meta_step_router: '',
      meta_active_label: '',
      meta_footer: '',
    },
    integrations: {
      ...
      modal_desc:
        'Wybierz źródła danych — PapaData połączy je w jeden model w BigQuery i zapewni spójność (waluty, strefy czasowe, kampanie, SKU).',
    ...
    roi: {
      ...
      reports_suffix: ' szt.',
      savings_disclaimer:
        'Obliczenia oparte na wprowadzonych przez Ciebie danych oraz średnich wzrostach efektywności.',
      ...
      rate_ent: 350,
      efficiency_note:
        'Odpowiednie decyzje bazowane na Twoich danych biznesowych i rekomendacjach PapaData, ukazywanie trendów i insighty z rynku, zwiększą efektywność Twojego biznesu o znacznie więcej niż jesteś w stanie zaoszczędzić z nami na samym starcie, dzięki oszczędności czasu.',
    },
    security: {
      pill: 'BEZPIECZEŃSTWO',
      ...
      card1_desc:
        'Kontrola dostępu zapewnia, że tylko upoważniony personel widzi konkretne dane i raporty.',
      card2_tag: 'IZOLACJA',
      card2_title: 'IZOLACJA DANYCH',
      card2_desc:
        'Środowisko każdego klienta jest izolowane na poziomie danych — brak mieszania danych.',
      card3_tag: 'MASKOWANIE',
      card3_title: 'MASKOWANIE DANYCH',
      card3_desc:
        'Dane PII są automatycznie maskowane przed analizą, aby ograniczyć ekspozycję danych wrażliwych.',
      card4_tag: 'SZYFROWANIE',
      card4_title: 'BEZPIECZNE POŁĄCZENIA',
      card4_desc:
        'Połączenia zewnętrzne są szyfrowane, a dane są chronione podczas przesyłania i w spoczynku.',
    ...
    socialProof: {
      ...
      reviews: [
        {
          quote: 'PapaData zmieniła nasz proces raportowania.',
          author: 'Jan Kowalski',
          role: 'CEO w FashionBrand',
        },
      ],
    },
    vertexPlayer: {
      ...
      content: {
        ai: {
          ...
          desc: 'Zadaj dowolne pytanie o swoje dane w języku naturalnym.',
        },
        pipeline: {
          title: 'Wykrywanie Anomalii',
          desc: 'Monitorowanie spadków wydajności w czasie rzeczywistym.',
        },
    ...
    papaAI: {
      ...
      suggestions: [
        {
          label: '🔍 Wykryj anomalie',
          prompt: 'Przeanalizuj widok {view} pod kątem anomalii w ostatnich 24h.',
        },
        {
          label: '📈 Rekomendacje budżetu',
          prompt: 'Gdzie powinienem zwiększyć budżet, aby utrzymać marżę?',
        },
    ...
    dashboard: {
      ...
      trial_expired_desc:
        'Funkcje produkcyjne są wstrzymane do czasu aktywacji subskrypcji. Dane i konfiguracje pozostają bez zmian.',
      ...
      billing: {
        trial_banner_tag: 'TRIAL',
        trial_banner_owner:
          'Trial kończy się za {days} dni. Dodaj metodę płatności, aby zachować dostęp.',
        trial_banner_member:
          'Trial kończy się za {days} dni. Poproś właściciela o dodanie płatności.',
        ...
        trial_modal_desc_7:
          'Trial kończy się za {days} dni. Dodaj metodę płatności, aby zachować ciągłość.',
      ...
      overview_v2: {
        ...
        insights: {
          items: [
            {
              id: 'ins-1',
              title: 'Największy spadek ROAS w kampanii X',
              impact: '-18% vs tydzień',
              context: 'Campaign X',
            },
            { id: 'ins-2', title: 'Zwroty rosną w SKU Y', impact: '+6% w 7d', context: 'SKU Y' },
            {
              id: 'ins-3',
              title: 'Nowy segment VIP zwiększa LTV',
              impact: '+12% w 30d',
              context: 'VIP Segment',
            },
          ],
        ...
        charts: {
          ...
          range: {
            label: 'Zakres',
            prompt: 'Własny',
            apply_local: 'Zastosuj',
            apply_global: 'Globalnie',
            clear: 'Wyczyść',
            start_label: 'Od',
            end_label: 'Do',
          },
        ...
        tables: {
          campaigns: {
            ...
            actions: {
              ...
              report: 'Raport',
              alert: 'Alert',
              view_all: 'Zobacz wszystkie reklamy',
            },
          },
          skus: {
            title: 'Top SKU',
            ...
            actions: {
              ...
              report: 'Raport',
              alert: 'Alert',
              inventory_hub: 'Centrum Magazynowe',
            },
          },
          sample: {
      ...
      growth: {
        title: 'SILNIK WZROSTU',
        desc: 'Skaluj swoją sprzedaż',
        cards: {
          title: 'Karty Rekomendacji',
          desc: 'Sugerowane działania biznesowe',
          labels: {
            impact: 'WPŁYW',
            confidence: 'UFNOŚĆ',
            effort: 'WYSIŁEK',
        ...
        budget: {
          title: 'Budżet',
          desc: 'Optymalizacja alokacji',
          toggle_channels: 'Kanały',
          toggle_campaigns: 'Kampanie',
          current_label: 'Obecny',
          suggested_label: 'Sugerowany',
          aggressiveness_label: 'Strategia',
          aggressiveness_steps: ['conservative', 'standard', 'aggressive'],
          aggressiveness_options: {
          ...
          assumptions_label: 'Założenia',
          assumptions_text: 'Oparte na historycznych trendach i AI.',
          channels: [],
          campaigns: [],
        },
      },
      ads_v2: {
        title: 'PŁATNE REKLAMY',
        desc: 'Efektywność wielokanałowa',
        summary: { roas_label: 'MIESZANY ROAS', roas_status: 'STABILNY', model_label: 'MODEL DDA' },
        media_mix: {
          title: 'Media Mix',
          desc: 'Alokacja budżetu',
          context_template: 'Mix: {name}',
          metric_spend: 'Wydatki',
          metric_revenue: 'Przychód',
          granularity_day: 'Dzień',
          granularity_week: 'Tydzień',
          badge_freshness: '',
          badge_quality: '',
          action_breakdown: 'Widok',
          action_explain: 'Analizuj',
          tooltip_share: 'Udział',
          tooltip_driver: 'Powód',
        },
        efficiency: {
          title: 'Efektywność',
          ...
          metric_roas: 'ROAS',
          metric_cpa: 'CPA',
          action_show_campaigns: 'Pokaż',
          action_explain: 'Wyjaśnij',
        },
        share: {
          title: 'Udział w rynku',
          desc: 'Share of Voice',
          spend_label: 'Udział w wydatkach',
          revenue_label: 'Udział w przychodach',
          delta_label: 'Δ',
          attention_badge: 'UWAGA',
        },
        creatives: {
          title: 'Reklamy',
          desc: 'Wyniki kreacji',
      ...
      products_v2: {
        title: 'Inteligencja SKU',
        desc: 'Dane produktowe i logistyczne',
        ai_prompt: 'Analizuj {name}',
        items: [
        ...
        scatter: {
          title: 'Matryca SKU',
          desc: 'Analiza marży vs wolumenu',
          context_template: 'Produkt: {name}',
          size_label: 'Wolumen',
          x_label: 'Marża %',
          y_label: 'Zysk netto',
          hint_top_right: 'BESTSELLERY',
          hint_bottom_right: 'DOJNE KROWY',
          hint_top_left: 'POTENCJAŁ',
          hint_bottom_left: 'OGONY',
          tooltip_profit: 'Profit',
          tooltip_margin: 'Marża',
          tooltip_units: 'Sztuki',
          tooltip_returns: 'Zwroty',
          tooltip_stock: 'Stan',
          tooltip_trend: 'Trend',
          tooltip_driver: 'Powód',
          tags: { toxic: 'TOKSYCZNY', high_margin: 'WYSOKA MARŻA', stock_risk: 'RYZYKO STANU' },
          multi_select_label: 'Zaznaczone',
          compare: { cta_ai: 'AI', cta_compare: 'Porównaj', cta_clear: 'X' },
        },
        details: {
          title: 'Szczegóły SKU',
          empty: 'Wybierz produkt z matrycy',
          empty_cta: 'Wybierz najpierw',
        ...
        movers: {
          title: 'Dynamika SKU',
          desc: 'Największe zmiany',
          rising_label: 'Wzrosty',
          falling_label: 'Spadki',
          cta_alert: 'Alert stanu',
          cta_ai: 'Wyjaśnij',
          driver_viral: 'Wirusowy trend',
          driver_search: 'Popyt w wyszukiwaniu',
          driver_stock: 'Optymalizacja stanów',
          driver_competition: 'Presja konkurencji',
          rising: [],
          falling: [],
        },
        table: {
          title: 'Lista Produktów',
          desc: 'Widok tabelaryczny',
          filters_label: 'Filtry',
          filters: ['TOKSYCZNY', 'BESTSELLER'],
          columns: {
            sku: 'KOD SKU',
            revenue: 'PRZYCHÓD',
            profit: 'ZYSK',
      ...
      customers_v2: {
        title: 'ANALIZA LOJALNOŚCI',
        desc: 'Retencja klientów i LTV',
        ai_prompt: 'Wyjaśnij {name}',
        summary: { retention_label: 'Śr. retencja', vip_label: 'Aktywni VIP' },
        cohorts: {
          title: 'Retencja Kohortowa',
          desc: 'Powracalność klientów',
          mode_month: 'Miesięcznie',
          mode_week: 'Tygodniowo',
          row_label: 'Data zakupu',
          row_prefix: 'M',
          col_prefix: 'M',
          small_sample: 'Mała próba',
          context_label: 'Kohorta',
          tooltip_retention: 'Retencja',
          tooltip_size: 'Rozmiar',
          tooltip_period: 'Okres',
        },
        ltv: {
          title: 'Krzywa LTV',
          desc: 'Wartość życiowa klienta',
          def: '30-dniowe LTV',
          tooltip_month: 'Miesiąc',
          tooltip_value: 'Wartość',
        },
        churn: {
          title: 'Ryzyko churnu',
      ...
      reports_v2: {
        title: 'AUTOMATIC REPORTS',
        desc: 'Zautomatyzowane podsumowania danych',
        last_report: {
          title: 'Ostatni raport',
          desc: 'Najnowszy plik',
        ...
        list: {
          ...
          items: [],
          actions: { preview: 'Widok', download: 'Pobierz', open: 'Link' },
        },
        generate: {
          title: 'Nowy Raport',
          desc: 'Szybkie generowanie',
          cta: 'Uruchom Silnik',
          fields: [{ label: 'L', value: 'V' }],
          sections: ['Overview', 'Revenue', 'Profit'],
        },
        ...
        export_history: [
          {
            ...
            name: 'Tygodniowe Podsumowanie',
            format: 'PDF',
            range: 'Ostatnie 7 dni',
            created: '12:40',
            urlLabel: 'signed-url',
          },
          {
            id: 'exp-2',
            name: 'Miesięczny Raport Zarządczy',
            format: 'CSV',
            range: 'Grudzień 2024',
            created: '09:15',
            urlLabel: 'signed-url',
      ...
      pipeline_v2: {
        title: 'DATA PIPELINE',
        desc: 'Status ETL i synchronizacji',
        ai_prompt: 'Analiza błędu {name}',
        actions: { open_guardian: 'Uruchom Guardian' },
        sources: {
          title: 'Źródła danych',
          desc: 'Surowe pobieranie danych',
          columns: {
            source: 'ŹRÓDŁO',
            status: 'STATUS',
            last_sync: 'SYNC',
          ...
          items: [],
          actions: { test: 'Testuj', sync: 'Sync', explain: 'Analizuj' },
        },
        transforms: {
          title: 'Transformacja',
          desc: 'Cleaning and RAG',
        ...
        rag: {
          ...
          status_label: 'Stat',
          status_value: 'OK',
          last_update_label: 'Akt',
          last_update_value: '1h temu',
          coverage_label: 'Pokr',
          coverage_value: '100%',
        },
        bigquery: {
          title: 'Baza BigQuery',
          desc: 'Hurtownia danych',
          cta_open: 'Otwórz BQ',
          cta_export: 'Eks',
          lineage_cta: 'Lineage',
          columns: { table: 'TABELA', desc: 'OPIS', freshness: 'ŚWIEŻOŚĆ', action: 'AKCJA' },
          items: [],
        },
      },
      guardian_v2: {
        title: 'DATA GUARDIAN',
        desc: 'Monitorowanie jakości i świeżości',
        ai_prompt: 'Problem z {name}',
        badge_label: 'Aktywne protokoły bezpieczeństwa',
        health_label: 'Zdrowie danych',
        health_status: 'BARDZO DOBRE',
        uptime_label: 'Dostępność (30d)',
        uptime_value: '99.98%',
        range_label: 'Okres analizy',
        range_options: ['24h', '7d', '30d'],
        only_issues_label: 'Tylko błędy',
        ...
        quality: {
          ...
          items: [
            {
              id: 'q1',
              title: 'Wykryto duplikaty zamówień',
              impact: 'Niespójność w przychodzie P&L',
              severity: 'Krytyczny',
            },
            {
              id: 'q2',
              title: 'Rozjazd wydatków reklamowych',
              impact: 'Meta Ads vs BigQuery różnica > 5%',
              severity: 'Ostrzeżenie',
            },
            {
              id: 'q3',
              title: 'Brak metadanych SKU',
              impact: 'Puste marże dla 12 nowych pozycji',
              severity: 'Info',
            },
            {
              id: 'q4',
              title: 'Opóźnienie połączenia ETL',
              impact: 'Latencja wzrosła do 450ms',
              severity: 'Ostrzeżenie',
            },
          ],
      ...
      integrations_v2: {
        title: 'INTEGRACJE',
        desc: 'Zarządzanie połączeniami',
        header_badge: 'Centrum integracji aktywne',
        search_placeholder: 'Szukaj konektora...',
        filters: {
          all: 'Wszystkie',
          active: 'Aktywne',
          disabled: 'Wyłączone',
        ...
        status_attention: 'Problem',
        status_connecting: 'Łączenie...',
        status_connected: 'Połączono',
        active_connectors_label: 'Aktywne integracje',
        records_synced_label: 'Zsynchronizowane rekordy',
        uptime_label: 'Dostępność (30 dni)',
        auth_prefix: 'Autoryzacja',
        sync_prefix: 'Sync',
        scope_label: 'Zakres',
        scope_default: 'Pełny dostęp',
        auth_label: 'Autoryzacja',
        last_sync_label: 'Sync',
        last_sync_recent: 'Przed chwilą',
        last_sync_delay: 'Opóźnienie',
        last_sync_disabled: 'Wyłączone',
        freshness_label: 'SLA',
        freshness_status: '99.9% OK',
        actions: { test: 'Testuj', details: 'Pokaż', refresh: 'Sync' },
        security_badge_label: 'Szyfrowanie aktywne',
        security_title: 'Bezpieczna centralizacja',
        security_desc:
          'Wszystkie połączenia są szyfrowane kluczem AES-256. Twoje dane pozostają w izolowanym środowisku BigQuery w wybranym regionie UE.',
        security_cta_keys: 'Zarządzaj kluczami',
        security_cta_sla: 'Pobierz raport SLA',
      },
      knowledge_v2: {
        title: 'BAZA WIEDZY',
        desc: 'Przewodniki i strategie',
        search_placeholder: 'Szukaj...',
        ai_prompt: 'Pomoc: {name}',
        ...
        detail: {
          title: 'Treść',
          empty: 'Wybierz poradnik',
          cta_apply: 'Zastosuj',
          cta_report: 'Do raportu',
        },
        ...
        booking: {
          ...
          guarantee_desc:
            'Sesja zostanie zafakturowana po potwierdzeniu terminu. Zwrot środków w przypadku braku konkretnych rekomendacji.',
        ...
        actions: {
          ...
          share_team: 'Udostępnij zespołowi',
        ...
        resources: [
          {
            ...
            videoId: 'meta-scaling-101',
            longContent:
              'Skalowanie kampanii Meta Ads wymaga przejścia od optymalizacji na poziomie zestawów reklam do podejścia opartego na Broad Targeting i silnych kreacjach. Dowiesz się, jak Advantage+ zmienia reguły gry oraz dlaczego retencja danych w BigQuery jest kluczowa dla modelowania atrybucji.\n\nKluczowe zagadnienia:\n- Struktura konta 2.0: Mniej znaczy więcej\n- Creative Testing framework: Wyłanianie zwycięzców\n- Wykorzystanie CAPI do stabilizacji wyników.',
          },
          {
            id: 'res-2',
            category: 'DATA',
            ...
            module: 'Pipeline',
            longContent:
              'Zrozumienie schematu danych w BigQuery to pierwszy krok do budowy zaawansowanych modeli LTV. Analizujemy różnice między strukturą zagnieżdżoną (NESTED) a płaską oraz wpływ partycjonowania na koszty operacyjne przy milionach rekordów zamówień.',
          },
          {
            id: 'res-3',
            category: 'AI',
            ...
            videoId: 'ai-prompts-mastery',
            longContent:
              'Papa AI nie jest tylko chatbotem. To interfejs do Twojej hurtowni danych. Naucz się stosować technikę Chain-of-Thought, aby asystent nie tylko podawał liczby, ale tłumaczył korelacje między ROAS a porzuconymi koszykami w konkretnych segmentach klientów.',
          },
        ],
      },
      settings_workspace_v2: {
        title: 'Ustawienia Workspace',
        desc: 'Konfiguracja przestrzeni roboczej',
          ...
          models: [
            {
              id: 'dda',
              label: 'Data-Driven AI',
              desc: 'Wykorzystuje ML do przypisania wagi każdemu punktowi styku.',
              default: true,
            },
            {
              id: 'last_click',
              label: 'Last Click Paid',
              desc: '100% konwersji trafia do ostatniego płatnego kanału.',
              default: false,
            },
            {
              id: 'linear',
              label: 'Liniowy',
              desc: 'Równy podział zasług między wszystkie interakcje.',
              default: false,
            },
            {
              id: 'first_click',
              label: 'First Click',
              desc: 'Premiuje kanały budujące świadomość u góry lejka.',
              default: false,
            },
          ],
        },
        ...
        footer_note: 'Wymagany zapis',
        cta_primary: 'Wdróż w trybie produkcyjnym',
        cta_secondary: 'Zapisz zmiany',
      },
      settings_org_v2: {
        title: 'Organizacje',
        desc: 'Zarządzanie kontem i rozliczeniami',
        ...
        privacy: {
          ...
          items: [],
          cta_export: 'Pobierz dane',
          cta_delete: 'Usuń konto',
        },
          ...
          billing_plans: [
            {
              id: 'starter',
              name: 'Starter',
              price: '159 PLN/mies. (rocznie) / 199 PLN/mies.',
              note: 'Do 3 źródeł, raport tygodniowy',
            },
            {
              id: 'pro',
              name: 'Professional',
              price: '399 PLN/mies. (rocznie) / 499 PLN/mies.',
              note: 'Do 15 źródeł, raport dzienny',
            },
            {
              id: 'enterprise',
              name: 'Enterprise',
              price: 'Wycena indywidualna',
              note: 'Nielimitowane źródła, real-time raporty',
            },
          ],
          invoices: [
        ...
        footer_note:
          'Zmiany w ustawieniach organizacji wpływają na wszystkie Workspace w ramach konta.',
        cta_save: 'Zapisz zmiany',
      },
      alerts_v2: {
        title: 'Alerty',
        desc: 'Alerty systemowe',
        domain_label: 'Domena',
        domains: ['Reklamy', 'Produkty'],
        state_label: 'Stan',
        states: ['Aktywne'],
        ...
        mock_alerts: [
          {
            title: 'Anomalia ROAS: Meta Ads',
            context: 'Wyniki Meta Ads',
            target: 'ads',
            severity: 'critical',
            baseProb: 0.9,
          },
          {
            title: 'Prognozowany Stock-out SKU-42',
            context: 'Logistyka magazynu',
            target: 'products',
            severity: 'warning',
            baseProb: 0.7,
          },
          ...
          {
            title: 'Opóźnienie ETL: Google Analytics',
            context: 'Pipeline GA4',
            target: 'guardian',
            severity: 'warning',
            baseProb: 0.6,
          },
          {
            title: 'Wzrost CPA: Search Brand',
            context: 'Google Ads Search',
            target: 'ads',
            severity: 'warning',
            baseProb: 0.5,
          ...
          {
            title: 'Nowy segment VIP zidentyfikowany',
            context: 'Segmentacja klientów',
            target: 'customers',
            severity: 'info',
            baseProb: 0.4,
          },
          {
            title: 'Błąd walidacji marży',
            context: 'Audyt P&L',
            target: 'pandl',
            severity: 'critical',
            baseProb: 0.85,
          ...
          {
            title: 'Niestabilność API Shopify',
            context: 'Konektor Shopify',
            target: 'integrations',
            severity: 'warning',
            baseProb: 0.3,
          },
          {
            title: 'Cel LTV osiągnięty: Kohorta M2',
            context: 'Retencja kohort',
            target: 'customers',
            severity: 'info',
            baseProb: 0.2,
          },
          {
            title: 'Wykryto ruch botów (Referral)',
            context: 'Jakość analityki',
            target: 'guardian',
            severity: 'warning',
            baseProb: 0.45,
          },
      ...
      pnl_title: 'P&L',
      pnl_model: 'Model',
      pnl_net_margin_label: 'Marża netto',
      ...
      pnl_gross_profit: 'Zysk brutto',
      pnl_net_profit: 'Zysk netto',
      pnl_after_opex: 'Po OpEx',
      pnl_waterfall: 'Waterfall',
      pnl_region_label: 'Region',
      pnl_final_state: 'Stan końcowy',
      pnl_cost_breakdown: {
      ...
      pnl_dim_category: 'Kategoria',
      pnl_badge_audited: 'Audytowane',
      pnl_revenue: 'Przychód',
      pnl_cogs: 'COGS',
      pnl_fees: 'Prowizje',
      pnl_refunds: 'Zwroty',
      pnl_shipping: 'Wysyłka',
      pnl_ad_spend: 'Wydatki na reklamy',
      pnl_payroll: 'Płace',
      pnl_tools: 'Narzędzia',
      pnl_contribution: 'Kontrybucja',
      pnl_export_live: 'Eksportuj Live',
      pnl_export_audit_pdf: 'Pobierz Audyt PDF',
      pnl_context_template: 'Linia P&L: {label} ({value})',
      pnl_ai_prompt_template:
        'Przeanalizuj pozycję P&L {label}. Czy wartość {value} jest optymalna przy przychodzie {revenue}?',
      pnl_ebitda_label: 'EBITDA',
      pnl_analyze_profitability: 'Analizuj rentowność',
      ads_title: 'Reklamy',
      ads_attribution: 'Atrybucja',
      ads_total_roas: 'ROAS',
      ads_status_optimal: 'Optymalny',
      ads_spend_vs_revenue: 'W/P',
      ads_latency: 'Opóźn',
      ads_label_spend: 'Wyd',
      ads_label_revenue: 'Przych',
      ads_automations: 'Auto',
      ads_agent: 'Agent',
      ads_auto_bid: 'Bidding',
      ads_anomaly_detect: 'Anomalia',
      ads_fraud_filter: 'Fraud',
      ads_creative_fatigue: 'Zmęczenie',
      ads_open_live: 'Live',
      ads_channel_matrix: 'Matryca',
      ads_model_refreshed: 'Odświeżono',
      ads_col_channel: 'Kn',
      ads_col_spend: 'Wydatki',
      ads_col_revenue: 'Przych',
      ads_col_roas: 'ROAS',
      ads_col_cpa: 'CPA',
      ads_col_conversions: 'Konw',
      customers_title: 'Klient',
      customers_dim_segment: 'Seg',
      customers_pii_masked: 'Zamaskowane',
      customers_segment_new: 'Nowi',
      customers_segment_returning: 'Powr',
      customers_segment_vip: 'VIP',
      customers_aov: 'AOV',
      customers_ltv: 'LTV',
      customers_repeat_rate: 'Powt',
      customers_open_cohorts_live: 'Kohorty',
      customers_cohort_title: 'Tytuł',
      customers_metric_returning: 'Powracający',
      customers_cohort_label: 'Kohorta',
      customers_month_label: 'Miesiąc',
      customers_model_note: 'Notka',
      products_title: 'Prod',
      products_dim_sku: 'SKU',
      products_stock_signal: 'Stan',
      products_col_sku: 'SKU',
      products_col_product: 'Produkt',
      products_col_units: 'Sztuki',
      products_col_revenue: 'Przych',
      products_col_margin: 'Marża',
      products_col_stock: 'Stan',
      products_col_status: 'Status',
      products_status_ok: 'Zdrowy',
      products_status_low: 'Niski',
      products_status_crit: 'Kryt',
      products_suggestion: 'Sug',
      products_restock_prefix: 'Zamów ',
      products_restock_suffix: ' szt.',
      products_open_inventory_live: 'Mag',
      products_price_signal: 'Cena',
      products_elasticity_model: 'Elast',
      products_discount_opt: 'Rab',
      products_bundle_opt: 'Pakiet',
      products_risk_stockout: 'Ryzyko',
      products_return_risk: 'Zwr',
      products_note_best_for: 'Najlepsze dla',
      products_note_bundle: 'Notka',
      products_note_risk_stockout: 'Ostrzeżenie',
      products_note_return_risk: 'Zwroty',
      products_open_pricing_lab: 'Cennik',
      alerts_title: 'Alerty',
      alerts_stream: 'Strumień',
      alerts_ack_required: 'Potw',
      alerts_action_prefix: 'Akcja: ',
      alerts_ack: 'Potw',
      alerts_acked: 'Potw',
      alerts_open_runbook: 'Runbook',
      alerts_notify_policy: 'Polityka',
      alerts_channel_email: 'Email',
      alerts_channel_slack: 'Slack',
      alerts_channel_sms: 'SMS',
      alerts_quiet_hours: 'Cisza',
      alerts_quiet_hours_window: 'Okno',
      alerts_connect_live_channels: 'Połącz',
      alerts_severity_alert: 'Alert',
      alerts_severity_security: 'Szyfr',
      alerts_severity_warning: 'Ostrz',
      alerts_severity_info: 'Info',
      ...
      settings_days: 'dni',
      settings_connector_tokens: 'Tokeny',
      settings_scoped_auth: 'Dostęp',
      settings_connector_shopify_label: 'Shopify',
      settings_connector_shopify_desc: 'Opis',
      settings_connector_allegro_label: 'Allegro',
      settings_connector_allegro_desc: 'Opis',
      settings_connector_google_ads_label: 'GAds',
      settings_connector_google_ads_desc: 'Opis',
      settings_connector_meta_capi_label: 'Meta',
      settings_connector_meta_capi_desc: 'Opis',
      settings_connector_ga4_label: 'GA4',
      settings_connector_ga4_desc: 'Opis',
      settings_connector_email_label: 'Email',
      settings_connector_email_desc: 'Opis',
      settings_apply_live: 'Zastosuj',
      status_enabled: 'Włączone',
      status_disabled: 'Wyłączone',
      status_on: 'Wł',
      status_off: 'Wył',
      status_monitor: 'Monitor',
      status_healthy: 'Zdrowy',
      status_syncing: 'Sync',
      status_high: 'Wysoki',
      status_low: 'Niski',
      tenant_mode_delay: 'Opóźn',
      tenant_mode_demo: 'Demo',
      tenant_mode_live: 'Live',
      workspace_mode_label: 'Tryb',
      btn_pin: 'Przypnij',
      btn_unpin: 'Odepnij',
      pnl_gross_margin_short: 'GM',
      ads_channels: [
      ...
      filter_option_desktop: 'Desk',
      filter_option_tablet: 'Tab',
      filter_option_new: 'Nowi',
      filter_option_returning: 'Powr',
      filter_option_vip: 'VIP',
      filter_option_top_sellers: 'Top',
      filter_option_low_margin: 'Low',
      filter_option_bundles: 'Pakiety',
      filter_option_shopify: 'Shopify',
      filter_option_allegro: 'Allegro',
      filter_option_pos: 'POS',
      sidebar_tagline: 'Tagline',
      nav_group_start: 'Start',
      nav_group_ai: 'AI',
      nav_group_performance: 'Perf',
      nav_group_fundamentals: 'Fund',
      ...
      command_empty: 'Brak',
      command_nav_hint: 'Hint',
      command_action_report: 'Rap',
      command_action_report_desc: 'Opis',
      command_action_alert: 'Alert',
      command_action_alert_desc: 'Opis',
      command_action_pipeline: 'Pipe',
      command_action_pipeline_desc: 'Opis',
      command_action_integrations: 'Int',
      command_action_integrations_desc: 'Opis',
      command_action_go_live: 'Live',
      command_action_go_live_desc: 'Opis',
      command_action_workspace: 'Work',
      command_action_workspace_desc: 'Opis',
      command_resource_roas: 'ROAS',
      command_resource_roas_desc: 'Opis',
      command_resource_bigquery: 'BQ',
      command_resource_bigquery_desc: 'Opis',
      command_resource_ai: 'AI',
      command_resource_ai_desc: 'Opis',
      notifications_title: 'Powiad',
      notification_roas_title: 'ROAS',
      notification_roas_desc: 'Opis',
      notification_roas_time: 'Czas',
      notification_delay_title: 'Opóźn',
      notification_delay_desc: 'Opis',
      notification_delay_time: 'Czas',
      notification_action_explain: 'Wyjaśnij',
      notification_action_open: 'Otwórz',
      notification_action_quality: 'Qual',
      context_meta_roas: 'Meta',
      context_label: 'Kontekst',
      context_clear: 'Wyczyść',
      filters_clear: 'Wyczyść',
      filters_empty: 'Puste',
      settings_shortcut: 'S',
      account_title: 'Konto',
      account_profile: 'PROFIL',
      account_access: 'DOSTĘP',
      account_billing: 'BILL',
      account_logout: 'WYLOGUJ',
      account_end_session: 'KONIEC',
      cta_go_live: 'GO',
      demo_banner_title: 'DEMO',
      demo_banner_desc: 'SYNTH',
      demo_banner_cta_primary: 'LIVE',
    ...
    promo_v2: {
      main: {
        ...
        subhead:
          'Podłącz źródła i zobacz KPI + alerty na własnych danych. Najczęściej wybierany: Professional.',
      ...
      intercept: {
        ...
        subhead:
          'Jeśli planujesz więcej niż 3 źródła lub chcesz otrzymywać codzienne alerty, Professional oszczędzi Twój czas od pierwszego dnia.',
        bullets: [
    ...
    cookies: {
      ...
      necessary_desc:
        'Zapewniają działanie strony, bezpieczeństwo i podstawowe funkcje (np. utrzymanie sesji, ochrona przed nadużyciami).',
      necessary_tag: 'WYMAGANE',
      analytical_label: 'Analityczne (GA4)',
      analytical_desc:
        'Pomagają nam zrozumieć, jak użytkownicy korzystają ze strony (np. liczba odwiedzin, źródła ruchu), aby poprawiać produkt i treści.',
      analytical_tag: 'OPCJONALNE',
      marketing_label: 'Marketingowe (Google Ads, Meta)',
      marketing_desc:
        'Służą do pomiaru skuteczności kampanii i — jeśli wyrazisz zgodę — do dopasowania reklam (np. remarketing).',
      marketing_tag: 'OPCJONALNE',
      functional_label: 'Funkcjonalne / Preferencje',
      functional_desc:
        'Zapamiętują dodatkowe ustawienia (np. preferencje) i ułatwiają korzystanie ze strony.',
      ...
      providers_desc:
        'Poniżej znajdziesz listę narzędzi używanych na stronie. Szczegóły (czas przechowywania, zakres danych, podstawy prawne) opisujemy w Polityce cookies.',
      provider_ga4:
        'Google Analytics 4 (Google LLC) – pomiar ruchu i zachowań na stronie (agregaty/statystyki).',
      provider_ads:
        'Google Ads (Google LLC) – konwersja pomiaru i skuteczności kampanii, remarketing (za zgodą).',
      provider_meta:
        'Meta Pixel (Meta Platforms, Inc.) – konwersja pomiaru i skuteczności kampanii, remarketing (za zgodą).',
      provider_gtm:
        'Google Tag Manager (Google LLC) – narzędzie do uruchamiania tagów; samo w sobie nie służy do profilowania.',
      cookie_ids_label: 'Przykładowe identyfikatory cookies',
      cookie_ids_desc:
        'Nazwy cookies mogą się różnić w zależności od konfiguracji i aktualizacji dostawców (np. _ga/_gid dla GA4, gcl* dla Google Ads, _fbp dla Meta).',
