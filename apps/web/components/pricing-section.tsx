...
export default function PricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="border-t border-brand-border bg-brand-dark/60 py-16 md:py-24"
    >
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
          {/* Konfigurator */}
          <div className="rounded-2xl border border-brand-border bg-brand-card/10 p-5 md:p-6">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="inline-flex rounded-full bg-brand-border p-1 text-xs">
                <button
                  type="button"
            ...
            <div className="mt-8 flex items-start gap-3 rounded-xl border border-brand-border bg-brand-dark/60 p-4">
              <input
                id="expert-support"
                type="checkbox"
                checked={withExpert}
          ...
          {/* Podsumowanie i CTA */}
          <div className="flex flex-col justify-between rounded-2xl border border-brand-border bg-gradient-to-b from-brand-dark/80 to-brand-dark p-5 md:p-6">
            <div className="space-y-3">
              ...
              <div className="mt-4 space-y-2 rounded-xl bg-brand-dark/80 p-4">
                ...
                {withExpert && (
                  <div className="flex items-center justify-between text-xs text-pd-muted">
                    <span>
                      {isEn
                ...
                <div className="mt-3 flex items-center justify-between border-t border-brand-border pt-3 text-xs text-pd-muted">
                  <span>
                    {isEn
                      ? billingPeriod === 'monthly'
                        ? 'Total due now'
                  ...
                  <span className="text-sm font-semibold text-pd-foreground">
                    {totalUpfront} PLN
                  </span>
                </div>
              </div>
            ...
            <div className="mt-6 space-y-2">
              <button
                type="button"
                className="flex w-full items-center justify-center rounded-xl bg-brand-accent px-4 py-2.5 text-sm md:text-base font-medium text-pd-bg shadow-sm transition-colors hover:bg-brand-accent hover:shadow-md"
                onClick={() => {
