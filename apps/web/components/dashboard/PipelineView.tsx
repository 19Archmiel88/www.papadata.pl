// PipelineView.tsx
// Widok "Pipeline": centrum zarządzania przepływem danych – źródła, transformacje,
// warstwa RAG i tabele BigQuery, z kontekstem dla Papa AI i akcji zarządczych.
...
export const PipelineView: React.FC = () => {
  ...
  const handleExplain = (label: string) => {
    ...
    setAiDraft?.(t.dashboard.pipeline_v2.ai_prompt.replace('{name}', label));
  };
    ...
    <div className="space-y-8 animate-reveal">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
              {t.dashboard.pipeline_v2.title}
            </h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {t.dashboard.pipeline_v2.desc}
            </p>
          </div>
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={() => handleExplain(t.dashboard.pipeline_v2.title)}
            ...
            >
              {t.dashboard.pipeline_v2.actions.open_guardian}
            </InteractiveButton>
            <button
              type="button"
              onClick={(event) =>
                openMenu(
                  event,
                  buildMenuItems(t.dashboard.pipeline_v2.title),
                  t.dashboard.pipeline_v2.title
                )
              }
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              {t.dashboard.pipeline_v2.sources.title}
            </h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {t.dashboard.pipeline_v2.sources.desc}
            </p>
          </div>
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => handleExplain(t.dashboard.pipeline_v2.sources.title)}
              className="text-xs font-black uppercase tracking-widest text-brand-start hover:underline"
            >
              {t.dashboard.context_menu.explain_ai}
            </button>
            <InteractiveButton
              ...
              onClick={() =>
                handleAction(
                  t.dashboard.pipeline_v2.sources.actions.test,
                  t.dashboard.pipeline_v2.sources.title
                )
              }
              disabled={isDemo}
            ...
            <InteractiveButton
              ...
              onClick={() =>
                handleAction(
                  t.dashboard.pipeline_v2.sources.actions.sync,
                  t.dashboard.pipeline_v2.sources.title
                )
              }
              disabled={isDemo}
            ...
            <button
              ...
              onClick={(event) =>
                openMenu(
                  event,
                  buildMenuItems(t.dashboard.pipeline_v2.sources.title),
                  t.dashboard.pipeline_v2.sources.title
                )
              }
              aria-label={t.dashboard.context_menu.label}
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="text-gray-500">
              <tr>
                {(Object.values(t.dashboard.pipeline_v2.sources.columns) as string[]).map(
                  (col) => (
            ...
            <tbody className="divide-y divide-black/5 dark:divide-white/5">
              {t.dashboard.pipeline_v2.sources.items.map((item: { id: React.Key | null | undefined; name: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; status: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; last_sync: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; delay: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; records: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; }) => (
                <tr
                  key={item.id}
                  onContextMenu={(event) =>
                    openMenu(event, buildMenuItems(String(item.name ?? '')), String(item.name ?? ''))
                  }
                ...
                >
                  ...
                  <td className="py-3">
                    ...
                    >
                      {t.dashboard.pipeline_v2.sources.actions.explain}
                    </button>
                  </td>
                </tr>
              ))}
      ...
      <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-3xl border border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#0b0b0f] p-6 shadow-xl">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                {t.dashboard.pipeline_v2.transforms.title}
              </h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                {t.dashboard.pipeline_v2.transforms.desc}
              </p>
            </div>
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={() => handleExplain(t.dashboard.pipeline_v2.transforms.title)}
                className="text-xs font-black uppercase tracking-widest text-brand-start hover:underline"
              >
                {t.dashboard.context_menu.explain_ai}
              </button>
              <InteractiveButton
                ...
                onClick={() =>
                  handleAction(
                    t.dashboard.pipeline_v2.transforms.actions.run,
                    t.dashboard.pipeline_v2.transforms.title
                  )
                }
                disabled={isDemo}
              ...
              <button
                ...
                onClick={(event) =>
                  openMenu(
                    event,
                    buildMenuItems(t.dashboard.pipeline_v2.transforms.title),
                    t.dashboard.pipeline_v2.transforms.title
                  )
                }
                aria-label={t.dashboard.context_menu.label}
        ...
        <div className="rounded-3xl border border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#0b0b0f] p-6 shadow-xl">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                {t.dashboard.pipeline_v2.rag.title}
              </h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                {t.dashboard.pipeline_v2.rag.desc}
              </p>
            </div>
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={() => handleExplain(t.dashboard.pipeline_v2.rag.title)}
                className="text-xs font-black uppercase tracking-widest text-brand-start hover:underline"
              >
                {t.dashboard.context_menu.explain_ai}
              </button>
              <InteractiveButton
                ...
                className="!px-3 !py-2 !text-xs rounded-full"
                onClick={() =>
                  handleAction(t.dashboard.pipeline_v2.rag.cta, t.dashboard.pipeline_v2.rag.title)
                }
                disabled={isDemo}
                title={isDemo ? demoTooltip : undefined}
              >
                {t.dashboard.pipeline_v2.rag.cta}
              </InteractiveButton>
              <button
                type="button"
                onClick={(event) =>
                  openMenu(
                    event,
                    buildMenuItems(t.dashboard.pipeline_v2.rag.title),
                    t.dashboard.pipeline_v2.rag.title
                  )
                }
                aria-label={t.dashboard.context_menu.label}
          ...
          <div className="mt-4 grid gap-3">
            <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 p-4 text-sm">
              <div className="text-xs text-gray-500">{t.dashboard.pipeline_v2.rag.status_label}</div>
              <div className="font-semibold text-gray-900 dark:text-white">
                {t.dashboard.pipeline_v2.rag.status_value}
              </div>
            </div>
            <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 p-4 text-sm">
              <div className="text-xs text-gray-500">
                {t.dashboard.pipeline_v2.rag.last_update_label}
              </div>
              <div className="font-semibold text-gray-900 dark:text-white">
                {t.dashboard.pipeline_v2.rag.last_update_value}
              </div>
            </div>
            <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 p-4 text-sm">
              <div className="text-xs text-gray-500">
                {t.dashboard.pipeline_v2.rag.coverage_label}
              </div>
              <div className="font-semibold text-gray-900 dark:text-white">
                {t.dashboard.pipeline_v2.rag.coverage_value}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="rounded-3xl border border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#0b0b0f] p-6 shadow-xl">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              {t.dashboard.pipeline_v2.bigquery.title}
            </h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {t.dashboard.pipeline_v2.bigquery.desc}
            </p>
          </div>
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => handleExplain(t.dashboard.pipeline_v2.bigquery.title)}
              className="text-xs font-black uppercase tracking-widest text-brand-start hover:underline"
            >
              {t.dashboard.context_menu.explain_ai}
            </button>
            {isDemo ? (
              ...
              <>
                <InteractiveButton
                  ...
                  onClick={() =>
                    handleAction(
                      t.dashboard.pipeline_v2.bigquery.cta_open,
                      t.dashboard.pipeline_v2.bigquery.title
                    )
                  }
                >
                ...
                <InteractiveButton
                  ...
                  onClick={() =>
                    handleAction(
                      t.dashboard.pipeline_v2.bigquery.cta_export,
                      t.dashboard.pipeline_v2.bigquery.title
                    )
                  }
                >
                ...
                <button
                  ...
                  onClick={(event) =>
                    openMenu(
                      event,
                      buildMenuItems(t.dashboard.pipeline_v2.bigquery.title),
                      t.dashboard.pipeline_v2.bigquery.title
                    )
                  }
                  aria-label={t.dashboard.context_menu.label}
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="text-gray-500">
              <tr>
                {(Object.values(t.dashboard.pipeline_v2.bigquery.columns) as string[]).map(
                  (col) => (
                    <th key={col} className="py-2 pr-4">
                      {col}
                    </th>
            ...
            <tbody className="divide-y divide-black/5 dark:divide-white/5">
              {t.dashboard.pipeline_v2.bigquery.items.map((item: { id: React.Key | null | undefined; name: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; desc: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; freshness: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; }) => (
                <tr
                  key={item.id}
                  onContextMenu={(event) =>
                    openMenu(event, buildMenuItems(String(item.name ?? '')), String(item.name ?? ''))
                  ...
                  <td className="py-3">
                    {isDemo ? (
                      <span className="text-xs text-gray-400">
                        {t.dashboard.pipeline_v2.bigquery.lineage_cta}
                      </span>
                    ) : (
                      <button
                        type="button"
