...
export const integrations: IntegrationItem[] = [
  ...
  { id: 'woocommerce', provider: 'woocommerce', category: 'ecommerce', status: 'live', auth: 'api_key' },
  { id: 'prestashop', provider: 'prestashop', category: 'ecommerce', status: 'live', auth: 'api_key' },
  { id: 'magento', provider: 'magento', category: 'ecommerce', status: 'beta', auth: 'api_key' },
  { id: 'bigcommerce', provider: 'bigcommerce', category: 'ecommerce', status: 'beta', auth: 'api_key' },
  ...
  { id: 'comarch_esklep', provider: 'comarch_esklep', category: 'ecommerce', status: 'coming_soon', auth: 'api_key' },
  { id: 'amazon_seller', provider: 'amazon_seller', category: 'marketplace', status: 'beta', auth: 'api_key' },
  ...
  { id: 'baselinker', provider: 'baselinker', category: 'marketplace', status: 'live', auth: 'api_key' },
  { id: 'channelengine', provider: 'channelengine', category: 'marketplace', status: 'beta', auth: 'api_key' },
  ...
  { id: 'microsoft_ads', provider: 'microsoft_ads', category: 'ads', status: 'beta', auth: 'oauth2' },
  ...
  { id: 'zalando_zms', provider: 'zalando_zms', category: 'ads', status: 'coming_soon', auth: 'oauth2' },
  ...
  { id: 'przelewy24', provider: 'przelewy24', category: 'payments', status: 'beta', auth: 'api_key' },
  ...
  { id: 'getresponse', provider: 'getresponse', category: 'email', status: 'beta', auth: 'api_key' },
  { id: 'salesmanago', provider: 'salesmanago', category: 'email', status: 'beta', auth: 'api_key' },
...
export const integrationsByProvider = integrations.reduce<Record<string, IntegrationItem>>((acc, item) => {
...
export const startIntegrationOAuth = async (
  ...
  return apiPost<IntegrationOAuthStartResponse>(`/integrations/${encodeURIComponent(provider)}/connect`, payload);
};
...
export const completeOAuth = async (
  ...
  return apiPost<IntegrationOAuthCallbackResponse>(`/integrations/${encodeURIComponent(provider)}/callback`, payload);
};
