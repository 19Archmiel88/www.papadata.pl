...
import type { SettingsWorkspaceResponse, SettingsOrgResponse } from '@papadata/shared';
...
export class SettingsService {
  ...
  async deleteOrg(params: { tenantId?: string; reason?: string; actorId?: string }): Promise<void> {
