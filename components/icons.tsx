...
export const CpuChipIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5m0 16.5v-1.5m3.75-12H21m-3.75 0h-1.5m-6 0H9m7.5 0h1.5m-1.5 0h-1.5m-6 0h-1.5m6 0h-1.5m7.5 0h1.5m-1.5 0h-1.5m-6 0h-1.5m6 0H9m-3.75 7.5H3m1.5 0h1.5m1.5 0H9m3.75 0h1.5m-1.5 0h1.5m4.5 0h1.5m-1.5 0h-1.5m-6-15v1.5m6 15v-1.5"
    />
